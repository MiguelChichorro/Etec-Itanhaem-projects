...
#jogos{
  height: 200px;
  width: 700px;
  background-image: url(imagem/camimascu.jpg);
...
#ace{
  height: 200px;
  width: 700px;
  background-image: url(imagem/camisafemini.jpg);
    background-size: cover;
...
#ca{
  height: 200px;
  width: 700px;
  background-image: url(imagem/moletonfor.png);
  background-size: cover;
...
#vid{
  height: 200px;
  width: 700px;
  background-image: url(imagem/casacodead.jpg);
    background-size: cover;
      background-position: center;
    transition: 0.5s;
    border: ridge 10px blue;
...
#vid:hover,#jogos:hover,#ca:hover,#ace:hover{
  ...
  width: 900px;
   ...
   <center>
    ...
    <h1>MASCULINO</h1>
    <hr>
    <button type="button" name="button"><a href="mascu.php"><fieldset id="jogos"></fieldset></a></button>
    <hr>
    <h1>FEMININO</h1>
    <hr>
    <button type="button" name="button"><a href="femini.php"><fieldset id="ace"></fieldset></a></button>
    <hr>
    <h1>MOLETONS</h1>
    <hr>
    <button type="button" name="button"><a href="moleton.php"><fieldset id="ca"></fieldset></a></button>
    <hr>
    <h1>CASACOS</h1>
    <hr>
    <button type="button" name="button"><a href="casaco.php"><fieldset id="vid"></fieldset></a></button>
</div>
        </div>
</center>
