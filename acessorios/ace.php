...
#jogos{
  height: 200px;
  width: 700px;
  background-image: url(imagem/headset.jpg);
...
#ace{
  height: 200px;
  width: 700px;
  background-image: url(imagem/control.jpeg);
    background-size: cover;
    transition: 0.5s;
    border: ridge 10px blue;
}
...
#ca{
  height: 200px;
  width: 700px;
  background-image: url(imagem/mouse.jpg);
  background-size: cover;
  transition: 0.5s;
  border: ridge 10px blue;
}
...
#vid{
  height: 200px;
  width: 700px;
  background-image: url(imagem/teclado.jpg);
    background-size: cover;
    transition: 0.5s;
    border: ridge 10px blue;
}
  ...
  width: 900px;
   ...
   <center>
    <div class="body">
      ...
      <h1>HEADSETS</h1>
      <hr>
      <button type="button" name="button"><a href="headset.php"><fieldset id="jogos"></fieldset></a></button>
      <hr>
      <h1>CONTROLES</h1>
      <hr>
      <button type="button" name="button"><a href="control.php"><fieldset id="ace"></fieldset></a></button>
      <hr>
      <h1>MOUSES</h1>
      <hr>
      <button type="button" name="button"><a href="mouse.php"><fieldset id="ca"></fieldset></a></button>
      <hr>
      <h1>TECLADOS</h1>
      <hr>
      <button type="button" name="button"><a href="teclado.php"><fieldset id="vid"></fieldset></a></button>
        </div>
</center>
