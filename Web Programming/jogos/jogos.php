...
#jogos{
  height: 200px;
  width: 700px;
  background-image: url(imagem/xboxexclu.jpg);
...
#ace{
  height: 200px;
  width: 700px;
  background-image: url(imagem/ps4exclu.jpg);
    background-size: cover;
    transition: 0.5s;
    border: ridge 10px blue;
}
...
#ca{
  height: 200px;
  width: 700px;
  background-image: url(imagem/swiexclu.jpg);
  background-size: cover;
  transition: 0.5s;
  border: ridge 10px blue;
}
...
#vid{
  height: 200px;
  width: 700px;
  background-image: url(imagem/pcexclu.jpg);
    background-size: cover;
    transition: 0.5s;
    border: ridge 10px blue;
}
  ...
  width: 900px;
   ...
   <center>
    <div class="body">
          ...
          <h1>XBOX ONE</h1>
          <hr>
          <button type="button" name="button"><a href="xboxo.php"><fieldset id="jogos"></fieldset></a></button>
          <hr>
          <h1>PS4</h1>
          <hr>
          <button type="button" name="button"><a href="ps4.php"><fieldset id="ace"></fieldset></a></button>
          <hr>
          <h1>SWITCH</h1>
          <hr>
          <button type="button" name="button"><a href="switch.php"><fieldset id="ca"></fieldset></a></button>
          <hr>
          <h1>PC</h1>
          <hr>
          <button type="button" name="button"><a href="pc.php"><fieldset id="vid"></fieldset></a></button>
    </div>
    </center>
